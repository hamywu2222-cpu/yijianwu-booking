...
export const ROOMS_SECTION = {
  ...
  family: {
    ...
    tags: ['2 張雙人床', '4–6 人', '衛浴共用'] as const,
    priceNote: '4 人起價',
...
export const OWLNEST_BOOKING = {
  ...
  sections: {
    guest: {
      ...
      lines: [
        '和鳴雙人房｜建議 2 人。可加 1 人（+$600，含日式軟墊/枕頭/毯子）。',
        '4–6人家庭房｜4 人起基本價 $3,200，每加 1 人 +$600（超過 6 人請斟酌）。',
      ],
    },
    booking: {
      title: '訂房小提醒',
      lines: [
        '網頁看得到房型代表有空房，找不到表示已售完。',
...
export const BOOKING_FAQ = [
  ...
  },
  {
    ...
    answer:
      '和鳴雙人房舒適建議 2 人，官網優惠價 NT$1,600/晚。若要多加 1 人，每人加 NT$600，並提供日式軟墊、枕頭、毯子。',
  },
  {
    question: '和風 4–6 人家庭房如何計價？',
    answer:
      '4 人起基本價 NT$3,200/晚，每增加 1 人加 NT$600（最多 6 人）。舒適建議 4–6 人，超過請自行斟酌空間與寢具安排。',
  },
  {
    question: '入住與退房時間是幾點？',
