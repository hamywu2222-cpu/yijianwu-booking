...
export const OWLNEST_BOOKING = {
  ...
  guestTips: [
    '請確認人數後再前往訂房付款。',
    '和鳴雙人房：舒適建議 2 人；若要多加 1 人 +NT$600（提供日式軟墊、枕頭、毯子）。',
    '4–6 人家庭房：4 人起基本價 NT$3,200，每加 1 人 +NT$600；舒適建議 4–6 人，超過請自行斟酌。',
  ],
} as const;
...
線上訂房請至官網訂房區；加入 LINE 官方 ${BUSINESS_LINE.id} 接收入住門禁密碼。急事來電 ${BUSINESS_PHONE.mobile}。
