...
export const HOME_PAGE_DESCRIPTION =
  '福隆車站民宿首選：出站步行約30秒即達一間屋・駅前宿。2026全新裝潢日式民宿，合法登記新北市民宿152號。沒開車、拖行李也能輕鬆入住；近福隆海水浴場、舊草嶺隧道。雙人雅房平日$1,500，官網直訂最優惠，LINE @811mszbh 自助入住。';

export const BOOKING_PAGE_TITLE =
  '立即訂房｜福隆車站民宿官網最優惠・出站30秒・一間屋';

export const BOOKING_PAGE_DESCRIPTION =
  '福隆車站附近住宿線上訂房：查空房、選房型、立即付款。出站步行約30秒。和鳴雙人雅房平日$1,500、包棟$8,800。官網保證最優惠，LINE @811mszbh 自助入住。';